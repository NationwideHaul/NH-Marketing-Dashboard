      ...
      <div className="w-full max-w-sm rounded-lg border border-border bg-card p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-md bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground hover:bg-secondary transition-colors disabled:opacity-50"
          >
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-card px-2 text-muted-foreground">or connect Google APIs</span>
          </div>
        </div>
